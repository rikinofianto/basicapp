...
namespace app\modules\admin\widget\dropzone;

use yii\helpers\Html;
use yii\helpers\Json;
use app\modules\admin\widget\dropzone\assets\DropZoneAsset;
...
class DropZone extends \yii\base\Widget
{
    ...
    public function run()
    {
        return Html::tag('div', $this->renderDropzone(), ['id' => $this->dropzoneContainer, 'class' => 'dropzone dropzone-sm']);
    }
