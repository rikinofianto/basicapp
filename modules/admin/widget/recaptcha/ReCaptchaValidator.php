...
namespace app\modules\admin\widget\recaptcha;
    ...
    public function init()
    {
        ...
        if (empty($this->secret)) {
            if (!empty(Yii::$app->get('reCaptcha')->secret)) {
                ...
                throw new InvalidConfigException('Required `secret` and `siteKey` param isn\'t set. '.PHP_EOL.' Please set this parameter');
            }
        }
