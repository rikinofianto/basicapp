...
use app\modules\admin\models\DclFieldConfig as DclFieldConfigModel;

/**
 * DclFieldConfig represents the model behind the search form about `app\modules\admin\models\DclFieldConfig`.
 */
